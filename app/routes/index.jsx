...
export default function Index() {
  ...
  return windowWidth > 1024 ? (
    <div className="w-fit p-10 h-fit relative">
      <div className="flex relative top-20 left-10">
        <img
      ...
      <div className="absolute right-3 flex z-50 top-60">
      ...
      <div className=" bg-[#84858c] clip-path-notched-xlg  w-fit p-1 h-fit">
        <div className=" bg-[#d1d8e2] clip-path-notched-xlg relative w-full p-20 h-full flex items-center justify-center">
